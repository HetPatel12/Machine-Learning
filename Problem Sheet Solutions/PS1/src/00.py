...
if args.p_num == 0 or args.p_num == 1:
    p01b(train_path=os.path.join(data_dir, 'ds1_train.csv'),
         eval_path=os.path.join(data_dir, 'ds1_valid.csv'),
         pred_path='output/p01b_pred_1.txt')

    p01b(train_path=os.path.join(data_dir, 'ds2_train.csv'),
         eval_path=os.path.join(data_dir, 'ds2_valid.csv'),
         pred_path='output/p01b_pred_2.txt')

    p01e(train_path=os.path.join(data_dir, 'ds1_train.csv'),
         eval_path=os.path.join(data_dir, 'ds1_valid.csv'),
         pred_path='output/p01e_pred_1.txt')
         #box_cox=True)

    p01e(train_path=os.path.join(data_dir, 'ds2_train.csv'),
         eval_path=os.path.join(data_dir, 'ds2_valid.csv'),
         pred_path='output/p01e_pred_2.txt')

# Problem 2
if args.p_num == 0 or args.p_num == 2:
    p02(train_path=os.path.join(data_dir, 'ds3_train.csv'),
...
if args.p_num == 0 or args.p_num == 3:
    p03(lr=1e-7,
        ...
        eval_path=os.path.join(data_dir, 'ds4_valid.csv'),
...
if args.p_num == 0 or args.p_num == 5:
    p05b(tau=5e-1,
         ...
         eval_path=os.path.join(data_dir, 'ds5_valid.csv'))
